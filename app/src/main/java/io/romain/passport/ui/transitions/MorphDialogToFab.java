...
package io.romain.passport.ui.transitions;
...
public class MorphDialogToFab extends ChangeBounds {
    ...
    private void setEndColor(@ColorInt int endColor) {
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPERTY_COLOR, ContextCompat.getColor(view.getContext(), R.color.background_light));
    ...
    public void captureEndValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPERTY_CORNER_RADIUS, endCornerRadius >= 0 ? endCornerRadius : view.getHeight() / 2);
    }
