 ...
 */
package io.romain.passport.ui.animation;
...
//	new Rotate3DAnimation(rotate, Angle.TO_DEGREES_0, duration, false)
	...
	public Rotate3DAnimation(Rotate rotate, Angle angle, int duration, boolean accelerate) {
		this.rotate = rotate;
		this.angle = angle;
	...
	public void initialize(int width, int height, int parentWidth, int parentHeight) {
		...
		super.setInterpolator(accelerate ? new AccelerateInterpolator() : new DecelerateInterpolator());
		camera = new Camera();
		centerX = width / 2.0f;
		centerY = height / 2.0f;
